...
export const churches: Church[] = [
  ...
  { slug: 'famille-d-austin', name_fr: "Famille d'Austin", name_en: 'Austin Family', location: 'US' },
  { slug: 'famille-de-boston', name_fr: 'Famille de Boston', name_en: 'Boston Family', location: 'US' },
  { slug: 'famille-de-floride-miami', name_fr: 'Famille de Floride', name_en: 'Florida Family', location: 'US' },
